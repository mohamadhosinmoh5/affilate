...
<style>
    ...
    .box {
        ...
        box-shadow: 5px 5px 5px 5px #f5f4ff;
        border-radius: 15px;
        margin: 20px;
        /* display: flex;
        flex-direction: column;
    ...
    .table_dash {
        ...
        box-shadow: 4px 4px 4px rgba(0, 0, 0, 0.1),
            ...
            /* سایه برای بالا و راست */
            4px -4px 4px rgba(0, 0, 0, 0.1),
            /* سایه برای پایین و چپ */
            -4px -4px 4px rgba(0, 0, 0, 0.1);
        /* سایه برای پایین و راست */
        width: 1100px;
        padding: 15px;
        background-color: #f5f4ff;
    }
...
<div class="row p-5">
    ...
    <div class="col-sm-6 p-2">
        <div class="box">
            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-bar-chart-line-fill" viewBox="0 0 16 16" style="color:#62a8ea">
                <path d="M11 2a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v12h.5a.5.5 0 0 1 0 1H.5a.5.5 0 0 1 0-1H1v-3a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3h1V7a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v7h1z" />
            </svg>
            <div class="box_title" style="color: #62a8ea;">مبلغ تجمعی صورت وضعیت ها</div>
            <div class="detail">
    ...
    {{-- <div class="col-sm-6">
            <div class="box">
                <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-cash-coin" viewBox="0 0 16 16" style="color: #46be8a ;">
                ...
                <div class="box_title" style="color: #46be8a;">کل درآمد</div>
                <div class="detail">2,000,000 تومان</div>
            </div>
        </div> --}}

    <div class="col-sm-6">
        <div class="box">
            <svg xmlns=" http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-list-check" viewBox="0 0 16 16" style="color: #57c7d4;">
                <path fill-rule="evenodd" d="M5 11.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5m0-4a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5m0-4a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5M3.854 2.146a.5.5 0 0 1 0 .708l-1.5 1.5a.5.5 0 0 1-.708 0l-.5-.5a.5.5 0 1 1 .708-.708L2 3.293l1.146-1.147a.5.5 0 0 1 .708 0m0 4a.5.5 0 0 1 0 .708l-1.5 1.5a.5.5 0 0 1-.708 0l-.5-.5a.5.5 0 1 1 .708-.708L2 7.293l1.146-1.147a.5.5 0 0 1 .708 0m0 4a.5.5 0 0 1 0 .708l-1.5 1.5a.5.5 0 0 1-.708 0l-.5-.5a.5.5 0 0 1 .708-.708l.146.147 1.146-1.147a.5.5 0 0 1 .708 0" />
            </svg>
            <div class="box_title" style="color: #57c7d4;">قرار داد های خاتمه یافته</div>
            <div class="detail">{{$delevery}}</div>
        </div>
    </div>

    <div class="col-sm-6">
        <div class="box">
            <svg xmlns=" http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-card-text" viewBox="0 0 16 16" style="color: #f2a654;">
                <path d="M14.5 3a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-13a.5.5 0 0 1-.5-.5v-9a.5.5 0 0 1 .5-.5zm-13-1A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h13a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2z" />
                <path d="M3 5.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5M3 8a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9A.5.5 0 0 1 3 8m0 2.5a.5.5 0 0 1 .5-.5h6a.5.5 0 0 1 0 1h-6a.5.5 0 0 1-.5-.5" />
            </svg>
            <div class="box_title" style="color: #f2a654;">تعداد قراردادها</div>
    ...
    <div class="col-sm-12 p-2">
        <div class="">
            <div class="table_title">
                ...
                <div class="dict_icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-folder2-open" viewBox="0 0 16 16" style="color: #a76aff;">
                        <path d="M1 3.5A1.5 1.5 0 0 1 2.5 2h2.764c.958 0 1.76.56 2.311 1.184C7.985 3.648 8.48 4 9 4h4.5A1.5 1.5 0 0 1 15 5.5v.64c.57.265.94.876.856 1.546l-.64 5.124A2.5 2.5 0 0 1 12.733 15H3.266a2.5 2.5 0 0 1-2.481-2.19l-.64-5.124A1.5 1.5 0 0 1 1 6.14zM2 6h12v-.5a.5.5 0 0 0-.5-.5H9c-.964 0-1.71-.629-2.174-1.154C6.374 3.334 5.82 3 5.264 3H2.5a.5.5 0 0 0-.5.5zm-.367 1a.5.5 0 0 0-.496.562l.64 5.124A1.5 1.5 0 0 0 3.266 14h9.468a1.5 1.5 0 0 0 1.489-1.314l.64-5.124A.5.5 0 0 0 14.367 7z" />
                    </svg>
                </div>
                <h5 class="card-title" style="font-size: 16pt; color:#a76aff; ">آخرین قراردادها</h5>
            </div>
            ...
            <table class="table table-striped" style="font-size: 12pt;">
                <thead>
                    <tr>
                        ...
                        <th scope="col">مبلغ اولیه قرارداد</th>
                    </tr>
                </thead>
                <tbody>
                    @foreach ($paginateData as $item )
                        <tr>
                            ...
                            <td class="num" id="{{$item->contract_first_amount}}">{{$item->contract_first_amount}}</td>
                        </tr>
                    @endforeach
            ...
            <div class="row text-center">
                {{$paginateData->links('pagination::bootstrap-4')}}
            </div>
        </div>
...
<script>
    ...
    inputElement.forEach((element) => {
        ...
        inputNumber = element.id;
        element.innerHTML = separateNumbers(inputNumber);
        console.log(inputElement)
    })

    // var inputNumber = inputElement.id;
